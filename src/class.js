        ...
        return function(){
            ...
            */
            if(this.status.toString()[0] == "4"){ // 4XX - CLIENT ERROR
                var error = new Error("4XX - CLIENT ERROR - " + this.status + " - " +  status_codes[this.status] +  " - " + this.uri);
            ...
            if(this.status.toString()[0] == "5"){ // 5XX - SERVER ERROR
                var error = new Error("5XX - SERVER ERROR - " + this.status + " - " +  status_codes[this.status] + " - " + this.uri);
                error.code = this.status; // append status code as error code
